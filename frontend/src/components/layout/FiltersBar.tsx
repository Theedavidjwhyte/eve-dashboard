...
export function FiltersBar() {
  const { currentTab, filters, setFilters, clearFilters, data } = useDashboardStore()
      ...
      {isFiltered && (
        <div className="flex flex-col justify-end ml-auto">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-destructive/40 text-destructive text-xs font-medium hover:bg-destructive/10 transition-colors"
