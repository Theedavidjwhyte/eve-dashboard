...
export interface Deal {
  ...
  _meddpicc?: number  // MEDDPICC score as percentage 0–100
  _elvAD?: string     // ELV AD owner for this account
  _isSplit?: boolean      // 50/50 Wingstop/Heineken split row
  _isExempt?: boolean     // ARR exempt (excluded from ARR calculations)
  _isNotElevate?: boolean // Not an Elevate account
  _accountId?: string     // Account Number from SF
  _splitType?: string     // Opportunity Split Type
}
