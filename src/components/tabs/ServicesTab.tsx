            ...
            <Table>
              ...
              <TableBody>
                {filtered.map((r, i) => {
                  ...
                  return (
                    <TableRow key={i}>
                      <TableCell className="font-medium text-xs">{(r.User ?? "").split(" ")[0]}</TableCell>
                      <TableCell className="text-xs font-medium max-w-[160px] truncate">{r["Opportunity Name"] ?? ""}</TableCell>
